          ...
          <div className="min-w-0">
            ...
            <div className="mt-5 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
              <div className="rounded-lg border border-border p-4 bg-background/40">
                <div className="font-semibold text-foreground text-base">1) Gear</div>
                <div className="text-muted-foreground mt-1 text-base leading-relaxed">Shoes, chalk, water, towel.</div>
              </div>
              <div className="rounded-lg border border-border p-4 bg-background/40">
                <div className="font-semibold text-foreground text-base">2) Warm up</div>
                <div className="text-muted-foreground mt-1 text-base leading-relaxed">5-10 mins easy movement.</div>
              </div>
              <div className="rounded-lg border border-border p-4 bg-background/40">
                <div className="font-semibold text-foreground text-base">3) Climb easy</div>
                <div className="text-muted-foreground mt-1 text-base leading-relaxed">Start with VB-V2 routes.</div>
              </div>
              <div className="rounded-lg border border-border p-4 bg-background/40">
                <div className="font-semibold text-foreground text-base">4) Cool down</div>
                <div className="text-muted-foreground mt-1 text-base leading-relaxed">Light stretch.</div>
              </div>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
        <Card className="p-6 sm:p-7">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="text-3xl font-display uppercase tracking-wider leading-snug">Technique Mini Guides</h3>
          </div>
        ...
        <Card className="p-6 sm:p-7">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="text-3xl font-display uppercase tracking-wider leading-snug">Climbing Glossary</h3>
          </div>
